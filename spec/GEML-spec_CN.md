...
| 键 | 宿主块 | 目标 | 定义于 |
|----|--------|------|--------|
| `data=#id` | `diagram`（`geml-chart`） | 同文档中的 `table` 块 | §7.1 |
| `of=#id` | `output` | 同文档中的 `code` 块 | §3 |
