...
created: 2026-07-03
issue: (design reviewed in docs/design/specs/geml-codemap/DESIGN-codemap-delta.md §2/§11-5)
---

## Summary

Register `geml-code-graph` as an interpreted diagram format: a layered
method-flow view over a **codemap** document tree (spec/profiles/geml-codemap/geml-codemap-profile.md).
...
4. **Index documents.** A codemap INDEX (meta declares `container =`)
   ...
   true path stays in the document's `src=`, see spec/profiles/geml-codemap/geml-codemap-profile.md §2),
