...
| 强调跨越内联 atom | `*a [链接](x) b*` 是包住链接的强调 | **不是强调** —— phase 2 只在单个字面文本段内配对定界符,于是星号保持字面,而且静默。强调里含代码 span、公式、图片时同理。是否保留见 [GEP-0007](../../spec/proposals/0007-emphasis-across-atoms.md) | ⚠️ |
